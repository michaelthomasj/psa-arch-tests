...
if(${SUITE} STREQUAL "IPC")
	message(FATAL_ERROR "IPC not supported for ${TARGET}, use -DTARGET=tgt_ff_tfm_ra6m4 instead")
else()
	list(APPEND PAL_SRC_C_NSPE
		...
		${PSA_ROOT_DIR}/platform/targets/tgt_dev_apis_tfm_ra6m4/drivers/ra/fsp/src/r_ioport/r_ioport.c
...
list(APPEND PAL_DRIVER_INCLUDE_PATHS
	...
	${PSA_ROOT_DIR}/platform/targets/tgt_dev_apis_tfm_ra6m4/drivers/ra/arm/CMSIS_5/CMSIS/Core/Include
