 ...
 * @defgroup BOARD_RA6M4_EK_INIT
 * @brief Board specific code for the RA6M4_EK Board
 *
 * This include file is specific to the RA6M4_EK board.
 *
 * @{
 **********************************************************************************************************************/
...
/** @} (end defgroup BOARD_RA6M4_EK_INIT) */
